...
def generate_api_meal_plan(df, target_kcal, carbs_ratio, fat_ratio, protein_ratio, nb_days):
    ...
    used_ids_global = set()  # Empêche répétition de recettes
    ingredient_usage_global = defaultdict(int)  # Limite ingrédients par semaine
    used_names_global = set()  # Empêche répétition de noms de plats
    ...
    for i in range(nb_days):
        ...
        for cat_id, meal_key in MEAL_TYPES.items():
            ...
            for _, row in valid.iterrows():
                ...
                # Vérifie limite d'ingrédient par jour/semaine
